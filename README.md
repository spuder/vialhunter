...
- **Lab testing**: a second, independent progress tracker underneath each order's shipping progress (Sample Shipped → Testing → Results — starts untouched until you mark the first step). Records the lab name, the sample's own carrier + tracking number, a group testing facilitator website, and free-text results.
